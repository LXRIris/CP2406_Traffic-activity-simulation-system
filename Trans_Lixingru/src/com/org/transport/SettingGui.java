...
public class SettingGui extends JFrame {
    ...
    public SettingGui() {
        ...
        JLabel delayLabel = new JLabel("green delay time");
        delayLabel.setBounds(73, 184, 127, 15);
        getContentPane().add(delayLabel);

        JLabel lblNewLabel = new JLabel("North and south intersection workshop separation");
        ...
        JLabel lblNewLabel_1 = new JLabel("East and west intersections produce workshop separation");
